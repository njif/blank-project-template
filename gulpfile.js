...
var config = {
	...
	css: {
		minify: true 	// TODO: DO NOT WORK WITH MIXIN?
		...
		bundles: {
			...
			development: {
				...
				filesArr: [
					...
					'src/assets/js/page-catalog.js',
					'src/assets/js/modal-window.js',
					'src/assets/js/appstate.js',
	...
	server: {
		copy: false, // Copy to local server or use 1. http-server or 2. 'gulp connectToDevServer' instead this (best variant)
		path: 'c:/WebServers/home/localhost/blankproject'
	}
};
